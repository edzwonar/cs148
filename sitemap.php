...
<html>
    <head>
        <meta charset="utf-8">
        <meta name="author" content="Emilie Dzwonar">
        <meta name="description" content="Sitemap">

        <meta name="viewport" content="width=device-width, initial-scale=1">
              <title>Emilie Dzwonar SiteMap</title>
        <style>
            h1 {
    ...
    <body>
        ...
        <ul>
            ...
            <ul>
                ...
                <li><a href="assignment2.0/tables.php?getRecordsFor=2">q02</a></li>
                <li><a href="assignment2.0/tables.php?getRecordsFor=3">q03</a></li>
                <li><a href="assignment2.0/tables.php?getRecordsFor=4">q04</a></li>
                <li><a href="assignment2.0/tables.php?getRecordsFor=5">q05</a></li>
